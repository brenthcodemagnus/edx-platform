...
class ImportRequiredTestCases(ContentStoreTestCase):
    ...
    def test_invalid_asset_overwrite(self):
        ...
        It Verifies that:
            During import, '/' in displayname of an asset are replaced with underscores '_'.
...
class MiscCourseTests(ContentStoreTestCase):
    ...
    def test_export_on_invalid_displayname(self):
        ...
        content_store = contentstore()
        invalid_displayname = '/Fake/asset/dispnayname'
        exported_asset_name = '_Fake_asset_dispnayname'

        # Create an asset with slash '/' in its 'displayname'
        ...
        # Verify that only single asset has been exported with the expected assetname.
