...
class ReverificationPartitionTest(ModuleStoreTestCase):
    ...
    def test_is_enrolled_in_verified_mode(self):
        self.assertTrue(
            VerificationPartitionScheme._is_enrolled_in_verified_mode(
    ...
    def test_has_skipped_any_checkpoint(self):
        self.assertFalse(
            VerificationPartitionScheme._has_skipped_any_checkpoint(
                self.user, self.course.id
            )
        )
    ...
    def test_user_has_completed_checkpoint(self):
        ...
        self.assertTrue(
            VerificationPartitionScheme._has_completed_checkpoint(
    ...
    def test_user_denied_at_any_checkpoint(self):
        ...
        self.assertTrue(
            VerificationPartitionScheme._was_denied_at_any_checkpoint(
                self.user_2, self.course.id
            )
        )
